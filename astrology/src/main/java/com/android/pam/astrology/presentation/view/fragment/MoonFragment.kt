...
class MoonFragment : Fragment(), IMoonContract.IView {
    ...
    private val moonObserver = Observer<MoonModel> { moonModel ->
        moonFragment_txv_moonrise.text = getString(R.string.moonrise).format(moonModel.moon.moonrise.time.toString())
        moonFragment_txv_moonset.text = getString(R.string.moonset).format(moonModel.moon.moonset.time.toString())
        moonFragment_txv_fullMoon.text = getString(R.string.fullMoon).format(moonModel.moon.nextFullMoon.date.toString())
        moonFragment_txv_newMoon.text = getString(R.string.newMoon).format(moonModel.moon.nextNewMoon.date.toString())
        moonFragment_txv_moonPhase.text = getString(R.string.moonPhase).format(moonModel.moon.moonPhase.percent.toString())
        moonFragment_txv_daySynodicMonth.text = getString(R.string.dayOfSynodicMonth).format(moonModel.moon.dayOfSynodicMonth.toString())
    }
